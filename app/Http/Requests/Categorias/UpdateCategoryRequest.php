...
use App\Rules\NoCicloJerarquiaCategoria;
...
class UpdateCategoryRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user()?->can('categorias.editar') ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            // NoCicloJerarquia previene auto-padre y ciclos transitivos (frontend
            // mitiga el caso obvio pero un curl directo lo permite — sin esto, la
            // BD queda con `parent` recursivos que cuelgan queries de breadcrumbs).
            'parent_id'   => ['nullable', 'exists:categories,id', new NoCicloJerarquiaCategoria($categoryId)],
