        ...
        <SidebarContext.Provider value={contextValue}>
            <TooltipProvider delayDuration={0}>
                <div
                    ...
                    className={cn(
                        "group/sidebar-wrapper flex min-h-screen w-full has-[[data-variant=inset]]:bg-white",
                        className
                    )}
                    {...props}
                >
...
function Sidebar({
    ...
    if (collapsible === "none") {
        return (
            <div
                data-slot="sidebar"
                className={cn(
                    "flex h-full w-[var(--sidebar-width)] flex-col bg-white text-slate-700",
                    className
                )}
                {...props}
            >
        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                <SheetContent
                    ...
                    data-slot="sidebar"
                    data-mobile="true"
                    className="w-[var(--sidebar-width)] bg-white p-0 text-slate-700"
    ...
    return (
        <div
            className="group peer hidden text-slate-700 md:block"
            data-state={state}
            ...
            data-slot="sidebar"
        >
            {/* sidebar gap — keeps the layout from collapsing when sidebar slides away */}
            <div
            ...
            <div
                ...
                data-side={side}
                className={cn(
                    "fixed inset-y-0 z-10 hidden h-screen w-[var(--sidebar-width)] transition-[left,right,width] duration-200 ease-linear",
                    ...
                    variant === "floating" || variant === "inset"
                        ...
                        : cn(
                            "group-data-[collapsible=icon]:w-[var(--sidebar-width-icon)]",
                            "group-data-[side=left]:border-r group-data-[side=left]:border-slate-200",
                            "group-data-[side=right]:border-l group-data-[side=right]:border-slate-200"
                          ),
                    className
                )}
                {...props}
            >
                <div
                    ...
                    className={cn(
                        ...
                        "group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-slate-200"
                    )}
                >
                    {children}
                </div>
    ...
    return (
        <button
            ...
            className={cn(
                ...
                "after:absolute after:inset-y-0 after:start-1/2 after:w-[2px] hover:after:bg-slate-200",
                "sm:flex",
                "[[data-side=left][data-state=collapsed]_&]:cursor-e-resize",
                "[[data-side=right][data-state=collapsed]_&]:cursor-w-resize",
                "group-data-[collapsible=offcanvas]:translate-x-0 group-data-[collapsible=offcanvas]:after:left-full",
                "hover:group-data-[collapsible=offcanvas]:bg-white",
...
const sidebarMenuButtonVariants = cva(
    [
        ...
        "data-[state=open]:hover:bg-slate-100 data-[state=open]:hover:text-slate-700",
        "data-[active=true]:bg-slate-100 data-[active=true]:font-medium data-[active=true]:text-slate-700",
    ...
    ].join(" "),
    {
        variants: {
            variant: {
                ...
                outline: "bg-white border border-slate-200 hover:bg-slate-100 hover:text-slate-700 hover:border-slate-300",
            },
            size: {
                default: "h-8 text-sm",
                sm:      "h-7 text-xs",
        ...
        <Comp
            ...
            className={cn(
                ...
                showOnHover && [
                    ...
                    "peer-data-[active=true]/menu-button:text-slate-700",
...
function SidebarMenuBadge({
    ...
    return (
        <div
            ...
            className={cn(
                "pointer-events-none absolute right-1 flex h-5 min-w-5 items-center justify-center rounded-md px-1 text-xs font-medium text-slate-700 tabular-nums select-none",
                "group-data-[collapsible=icon]:hidden",
                "peer-hover/menu-button:text-slate-700",
                "peer-data-[size=default]/menu-button:top-1.5",
                "peer-data-[size=lg]/menu-button:top-2.5",
    ...
    return (
        <Comp
            ...
            className={cn(
                ...
                "data-[active=true]:bg-slate-100 data-[active=true]:text-slate-700",
