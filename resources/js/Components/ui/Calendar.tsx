...
function Calendar({
    ...
    return (
        <DayPicker
            ...
            className={cn(
                "group/calendar bg-white p-2 [--cell-radius:0.5rem] [--cell-size:1.75rem]",
                className
            )}
            ...
            classNames={{
                ...
                caption_label: cn(
                    ...
                    captionLayout === "label"
                        ? "text-sm"
                        : "flex items-center gap-1 rounded-[var(--cell-radius)] text-sm [&>svg]:size-3.5 [&>svg]:text-slate-500",
                    defaultClassNames.caption_label
                ),
                table: "w-full border-collapse",
                weekdays: cn("flex", defaultClassNames.weekdays),
                weekday: cn(
                    "flex-1 rounded-[var(--cell-radius)] text-[0.8rem] font-normal text-slate-500 select-none",
                ...
                range_start: cn(
                    "relative isolate z-0 rounded-l-[var(--cell-radius)] bg-slate-100 after:absolute after:inset-y-0 after:right-0 after:w-4 after:bg-slate-100",
                    defaultClassNames.range_start
                ),
                range_middle: cn("rounded-none", defaultClassNames.range_middle),
                range_end: cn(
                    "relative isolate z-0 rounded-r-[var(--cell-radius)] bg-slate-100 after:absolute after:inset-y-0 after:left-0 after:w-4 after:bg-slate-100",
                    defaultClassNames.range_end
                ),
                today: cn(
                    "rounded-[var(--cell-radius)] bg-slate-100 text-slate-700 data-[selected=true]:rounded-none",
