...
interface Props {
    open:     boolean
    onClose:  () => void
    config:   IdentidadConfig | null
    colores:  Colores
    disabled: boolean
}

export default function ModalIdentidad({ open, onClose, config, colores, disabled }: Props) {
    ...
    function guardar() {
        setGuardando(true)
        router.post(route('admin.build.quienes-somos.identidad.config'), {
            titulo:            titulo      || null,
    ...
    return (
        <Sheet open={open} onOpenChange={v => { if (!v) onClose() }}>
            <SheetContent className="sm:max-w-lg flex flex-col">
                <SheetHeader>
                    <SheetTitle>Identidad</SheetTitle>
                    <SheetDescription>Título y descripción del hero.</SheetDescription>
                </SheetHeader>
                ...
                <div className="flex-1 overflow-y-auto px-4 py-4 space-y-5">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="space-y-1.5">
                            <Label htmlFor="id-titulo">Texto</Label>
                            <Input
                                id="id-titulo"
                                value={titulo}
                                maxLength={100}
                    ...
                    <div className="space-y-3">
                        ...
                        <Textarea
                            ...
                            placeholder="Una marca colombiana creada para quienes se niegan a elegir entre verse bien y cuidar su cabello."
                            rows={3}
                        />
                        <TokenSelector
